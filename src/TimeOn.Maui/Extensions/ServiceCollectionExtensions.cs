...
public static class ServiceCollectionExtensions
{
    public static MauiAppBuilder AddMobileServices(this MauiAppBuilder builder)
    {
        ...
        builder.Services.AddScoped<IDashboardSummaryService, RemoteDashboardSummaryService>();
    ...
    private static IConfiguration BuildConfiguration()
    {
        ...
        var stream = assembly.GetManifestResourceStream("TimeOn.Maui.appsettings.json");
...
#if ANDROID
        var androidStream = assembly.GetManifestResourceStream("TimeOn.Maui.appsettings.android.json");
        ...
        {
            var platformResourceName = $"TimeOn.Maui.appsettings.{platformSuffix}.json";
